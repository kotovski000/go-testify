...
func TestMainHandlerWhenCountMoreThanTotal(t *testing.T) {
	...
	require.Len(t, returnCafes, len(expectedCafes)) // Проверяем, что количество возвращенных кафе соответствует ожидаемому
	for _, cafe := range expectedCafes {            // Проверяем, что все доступные кафе присутствуют в возвращенном списке
		assert.Contains(t, returnCafes, cafe)
	}
}
